...
created.innerHTML=created.innerHTML+' Andres Jimenez';
...
function buildToDo(todo, index) {
  ...
  //tambien se puede agregar con .setAttribute  ó .classlist.add
...
// <div class='toDoShell'>
//    <span id=index class=?'completeText'> description
//    </span>
//  </div>
...
function buildToDos(toDos) {
  // Tu código acá:
  //toDos=[{description=comprar cosa,complete=ture/false},{description=comprar cosa,complete=ture/false}]
  //  i                           0                                     1 
 // var array=toDos.map(function(todo,i){
...
function completeToDo(event) {
  ...
  //event ->click
  //event.target -->span
  //event.target.id--> index del span
  // Tu código acá:
  toDoItems[index].completeToDo(); //compplete -->false -->true
  displayToDos();
}
